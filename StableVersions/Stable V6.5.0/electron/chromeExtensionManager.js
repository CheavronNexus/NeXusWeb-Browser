...
`
      // Find candidate script files
      const scriptFiles = ['background.js', 'polyfills.js', 'common.js']
      if (manifest.background?.service_worker) scriptFiles.push(manifest.background.service_worker)
      if (Array.isArray(manifest.background?.scripts)) scriptFiles.push(...manifest.background.scripts)
