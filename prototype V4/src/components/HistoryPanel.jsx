...
export default function HistoryPanel({ onClose, onNavigate }) {
  ...
  return (
    <PanelShell id="panel-history" title="History" icon={<History size={16} style={{ color: 'var(--accent-primary)' }} />} onClose={onClose} actions={clearBtn}>
      {/* Search */}
      ...
      {filtered.length === 0 ? (
        <div style={{ padding: 32, textAlign: 'center', color: 'var(--text-muted)', fontSize: 13 }}>
          <History size={36} style={{ margin: '0 auto 8px', color: 'var(--text-muted)', display: 'block' }} />
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      transition: 'color var(--t-fast)', display: 'flex', alignItems: 'center',
                    }}
