...
export default function DownloadPanel({ onClose, onToast }) {
  ...
  return (
    <PanelShell id="panel-downloads" title="Downloads" icon={<Download size={16} style={{ color: 'var(--accent-primary)' }} />} onClose={onClose} actions={clearBtn}>
      {downloads.length === 0 ? (
        <div style={{ padding: 36, textAlign: 'center', color: 'var(--text-muted)', fontSize: 13 }}>
          <Download size={36} style={{ margin: '0 auto 10px', color: 'var(--text-muted)', display: 'block' }} />
