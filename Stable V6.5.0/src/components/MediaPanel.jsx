...
import { Music, Pause, Play, Tv, Volume2, VolumeX, FastForward, Rewind } from 'lucide-react'
...
export default function MediaPanel({
  ...
  return (
    <PanelShell id="media-panel" title="Media HUD Controller" icon={<Music size={16} style={{ color: 'var(--accent-primary)' }} />} onClose={onClose}>
      <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            >
              {isMuted ? <><VolumeX size={14} /> Muted</> : <><Volume2 size={14} /> Mute</>}
            </button>
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      display: 'flex',
                      alignItems: 'center',
                      color: t.isMuted ? 'var(--red)' : 'var(--text-muted)',
                    }}
                    title={t.isMuted ? 'Unmute Tab' : 'Mute Tab'}
                  >
                    {t.isMuted ? <VolumeX size={14} /> : <Volume2 size={14} />}
                  </button>
                </div>
              ))}
            </div>
