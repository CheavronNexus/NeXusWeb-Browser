      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '14px 16px', scrollbarWidth: 'thin' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
            <div style={{ fontSize: 11.5, fontWeight: 600, color: '#e2e8f0', display: 'flex', alignItems: 'center', gap: 6 }}>
              <Shield size={14} style={{ color: vpnConfig.mode !== 'direct' ? '#38bdf8' : '#94a3b8' }} />
              <span>High-Speed Proxy / VPN</span>
            </div>
            <span style={{
              fontSize: 9.5,
              fontWeight: 700,
            ...
            {['direct', 'nl', 'us', 'sg', 'uk'].map(r => (
              <button
                ...
                style={{
                  ...
                  borderRadius: 5,
                  border: '1px solid',
                  borderColor: vpnConfig.region === r ? (isPrivateDen ? '#8b5cf6' : 'var(--accent-primary)') : 'rgba(255,255,255,0.08)',
                  background: vpnConfig.region === r ? (isPrivateDen ? 'rgba(139, 92, 246, 0.25)' : 'rgba(0, 212, 255, 0.18)') : 'transparent',
                  color: vpnConfig.region === r ? '#ffffff' : '#94a3b8',
                  cursor: 'pointer',
          ...
          <div style={{
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span>About NeXusWeb v5.0.0</span>
              </div>
              <ChevronRight size={13} style={{ color: '#64748b' }} />
            </div>
